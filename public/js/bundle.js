...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiMTFqZW0iLCJhIjoiY2t5d210aXh6MGE0NTJucWlqMmh3OWludiJ9.TBKIP1Kg1E4h1x10T2WFXg';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Adding markers

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Adding popups

    new mapboxgl.Popup({
      offset: 30,
      focusAfterOpen: false // closeButton: false,
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // Reload from the server and not from browser cache
...
var stripe = Stripe('pk_test_51KOnepHuZMbHxf66s41fvVVpNoBzAIZ3MTAIg6CUQ0lVz1Z0fd25kbijK8m1ld1iTRDZQlAMo3tXvBnKnmvH3aPl001d8mAIcx');
